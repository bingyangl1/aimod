...
| 版本 | 日期 | 关键变更 |
|------|------|---------|
| r54 | 2026-05-25 | PlanCache LLM规划持久化复用 + travel保留XZ速度不覆盖 |
| r53 | 2026-05-25 | 空闲采集检查背包已有数量，30s冷却，≥16跳过 |
| r52 | 2026-05-24 | PlaceBlock 降级链: 目标→下方→附近→脚下垫方块+跳 |
| r51 | 2026-05-24 | PlaceBlock 失败后搜附近空气，6次尝试后放弃 |
