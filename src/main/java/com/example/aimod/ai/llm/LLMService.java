...
public class LLMService {
    ...
    public LLMService() {
        // 从配置文件读取API设置
        this.apiUrl = com.example.aimod.config.ModConfig.getApiUrl();
        this.apiKey = com.example.aimod.config.ModConfig.getApiKey();
        this.model = com.example.aimod.config.ModConfig.getModelName();
        this.maxTokens = com.example.aimod.config.ModConfig.getMaxTokens();
        this.temperature = com.example.aimod.config.ModConfig.getTemperature();
        this.connectTimeoutMs = com.example.aimod.config.ModConfig.getConnectTimeoutSeconds() * 1000;
        this.readTimeoutMs = com.example.aimod.config.ModConfig.getReadTimeoutSeconds() * 1000;
        this.streamResponses = com.example.aimod.config.ModConfig.getStreamResponses();
